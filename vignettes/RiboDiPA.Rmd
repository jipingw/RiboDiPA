...
result.pst <- RiboDiPA(bam_file_list, gtf_file, classlabel, cores = 2)
```
...
`r formatC(result.pst$gene["YDR050C", "qvalue"], format = "e", digits = 2)`
and 
`r formatC(result.pst$gene["YDR064W", "qvalue"], format = "e", digits = 2)`.

...
![A diagram of RiboDiPA.](Figure1.png){width=90%}  
...
```{r fig2, fig.height = 12, fig.width = 9, out.width="90%", out.height="90%", fig.align = "center", warning=FALSE, message=FALSE, results='hide'}
...
```{r fig3, fig.height = 12, fig.width = 9, out.width="90%", out.height="90%", fig.align = "center", warning=FALSE, message=FALSE, results='hide'}
